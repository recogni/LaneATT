...
def match_proposals_with_targets(model: "LaneATT", proposals: torch.Tensor, targets: torch.Tensor, t_pos=15./640., t_neg=20./640.):
    ...
    valid_offsets_mask[all_indices, 5 + ends] = 1.  # n_prop * n_targets
